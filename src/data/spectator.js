const spectator = {
  ...
  content: [
    ...
    { "type": "section", "text": "Unused Alternative Designs" },
    { "type": "image", "src": "/images/spec-mobile/spec7.png" },


    { "type": "section", "text": "High Fidelity - Home" },
    { "type": "image", "src": "/images/spec-mobile/spec8.png" },


    { "type": "section", "text": "High Fidelity - Sections" },
    { "type": "image", "src": "/images/spec-mobile/spec9.png" },


    { "type": "section", "text": "High Fidelity - Profile" },
