  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (hash) {
        ...
        // If hash is removed manually, close? Or maybe just keep as is.
        // Usually deep link is for initial load or back/forward nav.
        // Let's decide: strictly sync state?
        // If user hits back button to clear hash, we should close.
